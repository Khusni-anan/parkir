...
PARKING_ROIS = {
    ...
    # --- KOLOM 2 (KIRI DALAM - Estimasi X=158) ---
    "B-01": [158, 100, 100, 32],
    "B-02": [158, 142, 100, 32],
    "B-03": [158, 184, 100, 32],
    "B-04": [158, 226, 100, 32],
    ...
    # --- KOLOM 3 (TENGAH KIRI - FIX USER: X=398) ---
    "C-01": [398, 100, 100, 32], # <-- Data Kamu
    "C-02": [398, 142, 100, 32],
    "C-03": [398, 184, 100, 32],
    "C-04": [398, 226, 100, 32],
    "C-05": [398, 268, 100, 32],
    ...
    # --- KOLOM 4 (TENGAH KANAN - Estimasi Geser X=511) ---
    "D-01": [511, 100, 100, 32],
    "D-02": [511, 142, 100, 32],
    "D-03": [511, 184, 100, 32],
    "D-04": [511, 226, 100, 32],
    ...
    # --- KOLOM 5 (KANAN DALAM - Estimasi Geser X=751) ---
    "E-01": [751, 100, 100, 32],
    "E-02": [751, 142, 100, 32],
    "E-03": [751, 184, 100, 32],
    "E-04": [751, 226, 100, 32],
    ...
    # --- KOLOM 6 (PALING KANAN - Estimasi Geser X=864) ---
    "F-01": [864, 100, 100, 32],
    "F-02": [864, 142, 100, 32],
    "F-03": [864, 184, 100, 32],
    "F-04": [864, 226, 100, 32],
